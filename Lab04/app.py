...
newsAEle = driver.find_element(
    By.XPATH,
    "/html/body/div[1]/div/main/div/div/div/article/div/div/div/div/section[2]/div/div/div[1]/div/div/div/div/nav[1]/ul/li[2]/a",
)
newsAEle.click()

firstArticleEle = driver.find_element(
    By.XPATH,
    "/html/body/div[1]/div/main/div[1]/div/div/article/div/div/div/div/section/div/div/div/div/div/div[3]/div/div/div[2]/div[1]/ul/li[1]/a",
)
...
inputEle = WebDriverWait(driver, 3).until(
...
secondResultEle = WebDriverWait(driver, 3).until(
    EC.presence_of_element_located((By.XPATH, "(//h3[contains(@class, 'LC20lb')])[2]"))
)
